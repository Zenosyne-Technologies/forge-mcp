...
| [read-tools](read-tools.md) | `src/tools/servers.ts`, `src/tools/sites.ts`, `src/tools/common.ts` | What list_servers, get_server and list_sites return, how to page through results with cursor and page_size, what the read-only annotations mean for an agent client, and which fields never appear on purpose. | active | 2026-09-03 |
